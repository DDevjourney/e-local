<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Nuevo producto</h2>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                <form action="{{ route('producto.store') }}" method="POST" x-data="{ enviando: false }" @submit="enviando = true" class="space-y-5">
                    @csrf
                    ...
                    <div class="flex justify-end gap-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <button type="submit" :disabled="enviando"
                            ...
                            <span x-text="enviando ? 'Guardando…' : 'Guardar producto'">Guardar producto</span>
                        </button>
                    </div>
                </form>
            </div>
